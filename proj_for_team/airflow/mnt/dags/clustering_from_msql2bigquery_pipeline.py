...
def _load_to_gcs():
    ...
    keyfile_gcs = f"/opt/airflow/dags/mypim-410508-32ab7ef6997f.json"#pim-clustering-load-to-gcs-410506-a515b5ff892c.json" # ใช้ path ของ container ก็คือ /opt/airflow/ add both
