...
default_args = {
    "start_date": timezone.datetime(2024, 4, 6), #yyyy-mm-dd
    "owner": "Tor Thanawat",
}
...
with DAG(
    ...
    task_id="train_model",
        sql="""
            CREATE OR REPLACE MODEL `careful-voyage-410506.customerdata1412.modelK4ClusteringaAddFeatureEng`
            OPTIONS (
                MODEL_TYPE = 'KMEANS',
                ...
                Is_Parent
            FROM
                `careful-voyage-410506.customerdata1412.clusteringtable`
    """,
